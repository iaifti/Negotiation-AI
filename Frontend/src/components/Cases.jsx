...
const Cases = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 mb-26 justify-evenly w-1/2 gap-10">
      <div className="bg-red-400/20 mt-3 p-4 py-5 gap-8 rounded-2xl flex flex-col items-center">
      ...
      <div className="bg-red-400/20 mt-3 p-4 py-5 gap-8 rounded-2xl flex flex-col items-center">
        ...
        <FaHandshakeAngle className="text-Secondary/80 text-4xl lg:text-5xl" />
        <span>
      ...
      <div className="bg-red-400/20 mt-3 p-4 py-5 gap-8 rounded-2xl flex flex-col items-center">
        ...
        <GiPriceTag className="text-Secondary/80 text-4xl lg:text-5xl " />
        <span>
